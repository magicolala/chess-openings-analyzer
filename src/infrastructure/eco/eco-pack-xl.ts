...
export const ECO_PACK_XL = [
  ...
  [
    ["e4", "c5", "Nf3", "d6", "d4", "cxd4", "Nxd4", "Nc6", "Be2", "e6"],
    "Sicilienne Scheveningen (setup)",
  ],
  ...
  [
    ...
    "Nimzo-Indienne, Capablanca",
  ],
  [
    ["d4", "Nf6", "c4", "e6", "Nc3", "Bb4", "e3", "O-O", "Bd3", "d5"],
    "Nimzo-Indienne, Rubinstein",
  ],
  [
    ["d4", "Nf6", "c4", "e6", "Nc3", "Bb4", "a3", "Bxc3+", "bxc3"],
    "Nimzo-Indienne, Sämisch",
  ],
  [
    [
      "d4",
  ...
  // ——— SYSTÈMES d4 sans c4 ———
  [
    ["d4", "Nf6", "Bf4", "g6", "e3", "Bg7", "Nf3", "O-O", "h3"],
    "Système de Londres",
  ],
  [
    ["d4", "Nf6", "Nf3", "e3", "Bd3", "O-O", "O-O", "b3", "Bb2"],
    "Colle-Zukertort",
  ],
  ...
  [
    ...
    "Catalane Ouverte (reprise)",
  ],

  // ——— HOLLANDAISE ———
  [
    ["d4", "f5", "c4", "Nf6", "g3", "g6", "Bg2", "Bg7", "Nf3", "O-O"],
    "Hollandaise Leningrad",
  ],
  [
    [
      "d4",
  ...
  [
    ...
    "Anglaise Quatre Cavaliers, fianchetto",
  ],
  [
    [
      "c4",
    ...
    "Anglaise Symétrique, plan Botvinnik",
  ],
  [["c4", "e5", "g3", "Nf6", "Bg2", "d5"], "Anglaise, Sicilienne inversée"],
  [
    ["Nf3", "d5", "g3", "Nf6", "Bg2", "c6", "O-O", "Bf5"],
    "Réti, set-up Caro inversé",
  ],
  [
...
export const ECO_TRAPS = [
  ...
  [
    ...
    "Piège: Fried Liver alert (les Noirs doivent jouer ...Na5 ou ...Nd4)",
  ],
  [
    ["e4", "e5", "Nf3", "Nc6", "Bc4", "Nf6", "Ng5", "Bc5"],
    "Piège: Traxler (Wilkes-Barre) tactiques sauvages",
  ],
  [
    ["e4", "e5", "Nf3", "Nc6", "Bc4", "d6", "Nc3", "Bg4", "h3", "Bh5", "Nxe5"],
    "Piège: Mat de Légal thématique si ...Bxd1?? Qxf7# suit",
  ],
  [
    ["e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5", "b4", "Bxb4", "c3", "Ba5", "d4"],
    "Piège: Evans Gambit initiative violente",
  ],

  // ——— Ruy Lopez ———
  [
    ["e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4", "d6", "d4"],
    "Piège: Ruy Lopez, menaces sur e5 et fourchettes rapides",
  ],
  [
    ["e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4", "Nf6", "O-O", "Nxe4"],
    "Piège: Ruy Lopez Ouverte, tactiques sur e5/d4",
  ],
  [
    [
      "e4",
    ...
    "Piège: Noé (Noah’s Ark) motifs de piège de pions sur c3/d4",
  ],
  ...
  [
    ...
    "Piège: Najdorf Poisoned Pawn idées tactiques",
  ],
  [
    ["e4", "c5", "Nf3", "Nc6", "Bb5", "g6", "O-O", "Bg7", "Re1", "e5", "b4"],
    "Piège: Rossolimo, sacrifices b4/b5 surcadenassage",
  ],
  [
    ["e4", "c5", "d4", "cxd4", "c3", "dxc3", "Nxc3"],
    "Piège: Smith-Morra, tactiques rapides sur e5/f7",
  ],
  ...
  [
    ...
    "Piège: Winawer Poisoned Pawn (Qg4)",
  ],
  [
    ["e4", "e6", "d4", "d5", "Nd2", "c5", "exd5", "exd5", "Ngf3", "Nc6", "Bb5"],
    "Piège: Tarrasch, pressions précoces c5/d4",
  ],

  // ——— Caro-Kann ———
  [
    ["e4", "c6", "d4", "d5", "e5", "Bf5", "g4", "Be4", "f3"],
    "Piège: Caro-Kann Avance, rafales g4-f3 piègent le Fou",
  ],
  [
    [
      "e4",
    ...
    "Piège: Harass du Fou g6 après h4-h5",
  ],

  // ——— Scandinave ———
  [
    ["e4", "d5", "exd5", "Qxd5", "Nc3", "Qa5", "d4", "Bd7", "Nf3", "Nc6", "d5"],
    "Piège: Scandinave, poussée d5 gagnant du temps",
  ],
  ...
  [
    ...
    "Piège: Pirc ruptures thématiques e5/d5",
  ],
  [
    ["e4", "Nf6", "e5", "Nd5", "d4", "d6", "Nf3", "Bg4", "Be2", "Nc6", "c4"],
    "Piège: Alekhine, surcharges centrales",
  ],
  ...
  [
    ...
    "Piège: Cambridge Springs/Elephant Trap motif (…Nxd5! punition)",
  ],
  [
    [
      "d4",
    ...
    "Piège: Cambridge Springs, tactiques Qa5",
  ],
  [
    [
      "d4",
    ...
    "Piège: QGD Orthodoxe, clouages sur f6",
  ],
  ...
  [
    ...
    "Piège: Semi-Slav, thème Noteboom",
  ],
  [
    [
      "d4",
    ...
    "Piège: Slav Échange, appât sur b7",
  ],

  // ——— QGA ———
  [
    ["d4", "d5", "c4", "dxc4", "e4", "e5", "Nf3", "exd4", "Bxc4"],
    "Piège: QGA, central crush si ...e5? mal géré",
  ],
  ...
  [
    ...
    "Piège: Nimzo Qc2, tactiques sur e4/c7",
  ],
  [
    [
      "d4",
    ...
    "Piège: Ouest-Indienne, thèmes sur e4/d5",
  ],
  ...
  [
    ...
    "Piège: Grünfeld Échange, pression long diag",
  ],
  [
    [
      "d4",
  ...
  [
    ...
    "Piège: Benoni moderne, ruptures e5-f5",
  ],
  [
    ["d4", "Nf6", "c4", "c5", "d5", "b5", "cxb5", "a6"],
    "Piège: Benko, matériel contre initiative",
  ],

  // ——— London / Colle / Jobava / Trompowsky ———
  [
    ["d4", "Nf6", "Bf4", "c5", "d5", "Qb6", "Nc3"],
    "Piège: Londres anti-...Qb6, piège sur b2/d5",
  ],
  [
    ["d4", "Nf6", "Nc3", "Bf4", "d5", "Nb5", "Qa5+", "Nc3", "e5"],
    "Piège: Jobava, sauts tactiques Nb5",
  ],
  [
    ["d4", "Nf6", "Bg5", "c5", "d5", "Qb6", "Nc3"],
    "Piège: Trompowsky, affaiblissements sur b6",
  ],
  ...
  [
    ...
    "Piège: Leningrad, tactiques sur e-file",
  ],
  [
    [
      "d4",
    ...
    "Piège: Classique, attaque sur h2/h7 qui se retourne",
  ],
  ...
  [
    ...
    "Piège: Anglaise, contre-attaques sur b-file",
  ],
  [
    [
      "Nf3",
    ...
    "Piège: Réti, thèmes e4/c4",
  ],

  // ——— Divers pièges rapides “pub quiz” ———
  [
    ["e4", "e5", "Qh5", "Nc6", "Bc4", "Nf6", "Qxf7"],
    "Piège: Mat du Berger (pour mémoire)",
  ],
  [
    ["e4", "e5", "Nf3", "Nc6", "Bc4", "Nd4", "Nxe5", "Qg5", "Bxf7+"],
    "Piège: Blackburne-Shilling, punition sur ...Nd4?!",
  ],
  [
    ["e4", "c5", "Qh5", "Nc6", "Qxc5"],
    "Piège: “patzer” anti-sicilienne, attention ...e5!",
  ],
];
