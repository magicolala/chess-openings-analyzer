...
function normalizeToTokens(pgn) {
  ...
  export const TRAP_PACK = [
    ...
    { id:'fried-liver', name:'Piège: Fried Liver', side:'white',
    ...
    { id:'traxler', name:'Piège: Traxler (Wilkes-Barre)', side:'black',
    ...
    { id:'legall', name:'Piège: Mat de Légal (motif)', side:'white',
      openingTags:['Italienne','Giuoco','Philidor'],
      seq:['e4','e5','Nf3','Nc6','Bc4','d6','Nc3','Bg4','h3','Bh5','Nxe5'],
      advice:"Si …Bxd1?? Qxf7+ puis mat. Ne sur-utilise pas, bon niveau = vaccinés."},
  
    // Ruy Lopez
    { id:'open-spanish-tactic', name:'Piège: Espagnole ouverte', side:'black',
      openingTags:['Ruy Lopez','Espagnole'],
      seq:['e4','e5','Nf3','Nc6','Bb5','a6','Ba4','Nf6','O-O','Nxe4'],
      advice:"…Nxe4 force des complications; connais d’abord …Be7 lignes calmes."},
    { id:'noah-ark', name:'Piège: Espagnole motif “Arche de Noé”', side:'black',
      openingTags:['Ruy Lopez','Espagnole'],
      seq:['e4','e5','Nf3','Nc6','Bb5','a6','Ba4','b5','Bb3','Na5','c3','Nxb3','Qxb3','d6','d4'],
      advice:"…exd4 c4-c5 piège le fou blanc sur b3 si mal géré."},
  
    // Sicilienne
    { id:'najdorf-poisoned', name:'Piège: Najdorf Poisoned Pawn', side:'black',
      openingTags:['Najdorf','Sicilienne'],
      seq:['e4','c5','Nf3','d6','d4','cxd4','Nxd4','Nf6','Nc3','a6','Bg5','e6','f4','Qb6'],
      advice:"…Qb6 vise b2. Si tu n’as pas les reférences, n’y va pas en blitz."},
    { id:'rossolimo-b4', name:'Piège: Rossolimo b4-b5', side:'white',
      openingTags:['Rossolimo','Moscou','Sicilienne'],
      seq:['e4','c5','Nf3','Nc6','Bb5','g6','O-O','Bg7','Re1','e5','b4'],
      advice:"b4-b5 casse la structure si …axb5? motifs tactiques sur e5/c6."},
    { id:'morra-tactics', name:'Piège: Smith-Morra motifs', side:'white',
      openingTags:['Smith-Morra','Sicilienne'],
      seq:['e4','c5','d4','cxd4','c3','dxc3','Nxc3'],
      advice:"Développement turbo; vise e5/f7. Si noir rend le pion tôt, adapte."},
  
    // Française
    { id:'winawer-poisoned', name:'Piège: Winawer Poisoned Pawn', side:'white',
      openingTags:['Française','Winawer'],
      seq:['e4','e6','d4','d5','Nc3','Bb4','e5','c5','a3','Bxc3+','bxc3','Ne7','Qg4'],
      advice:"Qg4 gratte g7/b7. Connais les files ouvertes pour punir …Qc7?."},
  
    // Caro-Kann
    { id:'ck-advance-bishop-trap', name:'Piège: Caro-Kann Avance, fou piégé', side:'white',
      openingTags:['Caro-Kann'],
      seq:['e4','c6','d4','d5','e5','Bf5','g4','Be4','f3'],
      advice:"Plan g4-f3 pour enfermer le fou. Ne force pas si …h5 précis."},
  
    // Scandinave
    { id:'scandi-d5-push', name:'Piège: Scandinave poussé d5', side:'white',
      openingTags:['Scandinave'],
      seq:['e4','d5','exd5','Qxd5','Nc3','Qa5','d4','Bd7','Nf3','Nc6','d5'],
      advice:"Gain de temps sur la dame noire. Surveille …Nb4 idées."},
  
    // QGD / Cambridge / Elephant
    { id:'elephant-trap', name:'Piège: Elephant Trap (QGD)', side:'black',
      openingTags:['QGD','Cambridge Springs'],
      seq:['d4','d5','c4','e6','Nc3','Nf6','Bg5','Nbd7','cxd5','exd5','Nxd5'],
      advice:"…Nxd5! et si Bxd8?? Bb4+ gagne la dame. Classique de club."},
  
    // Slav / Semi-Slav
    { id:'slav-qb3', name:'Piège: Slav Qb3 sur b7', side:'white',
      openingTags:['Slave'],
      seq:['d4','d5','c4','c6','cxd5','cxd5','Nc3','Nc6','Bf4','Nf6','e3','Bf5','Qb3'],
      advice:"Appât b7. Si …Qb6 égalise, bascule en plan e4 rapide."},
  
    // QGA
    { id:'qga-central', name:'Piège: QGA central crush', side:'white',
      openingTags:['QGA'],
    ...
    { id:'nimzo-qc2-tactics', name:'Piège: Nimzo Qc2 tactiques', side:'white',
      openingTags:['Nimzo-Indienne'],
      seq:['d4','Nf6','c4','e6','Nc3','Bb4','Qc2','O-O','a3','Bxc3+','Qxc3'],
      advice:"Tactiques sur e4/c7. Ne dors pas sur …d5 rapide."},
  
    // Grünfeld / KID
    { id:'grunfeld-exchange', name:'Piège: Grünfeld Échange pression', side:'white',
      openingTags:['Grünfeld'],
      seq:['d4','Nf6','c4','g6','Nc3','d5','cxd5','Nxd5','e4','Nxc3','bxc3','Bg7','Nf3','c5','Rb1'],
      advice:"Pression diagonale et b-file. Prévois h3-Bg5 si …Qa5+."},
    { id:'kid-saemisch-d5', name:'Piège: KID Sämisch d5!', side:'white',
      openingTags:['KID','Est-Indienne'],
      seq:['d4','Nf6','c4','g6','Nc3','Bg7','e4','d6','f3','O-O','Be3','e5','Nge2','Nc6','d5'],
      advice:"d5 au bon timing punit …Nc6-e5 superficiel."},
  
    // Benoni / Benko
    { id:'benko-accept', name:'Piège: Benko accepté, initiative', side:'black',
  ...
  // ---------------- TRIE ----------------
  class TrieNode {
    constructor() { this.children = new Map(); this.ends = []; }
  }
    ...
    matchTokens(tokens, { openingLabel = '', side = null, maxPlies = 30 } = {}) {
      ...
      for (let i = 0; i < Math.min(tokens.length, maxPlies); i++) {
        ...
        if (progressed >= 3 && (!node.ends.length)) {
          near.push({
            startPly: i, matchedPlies: progressed,
    ...
    recommendByOpening(openingLabel, side, limit = 5) {
      ...
      for (const t of this.byId.values()) {
        ...
        if (t.openingTags.some(tag => l.includes(tag.toLowerCase()))) {
          picks.push({ id:t.id, name:t.name, side:t.side, seq:t.seq, advice:t.advice });
        }
      }
